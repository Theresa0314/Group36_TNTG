...
public class FirebaseDatabase {
    private com.google.firebase.database.FirebaseDatabase instance = com.google.firebase.database.FirebaseDatabase.getInstance();
    ...
    public MutableLiveData<StorageReference> fetchFileReference(String timeStamp, Uri imageUri, Context context) {
        ...
        final StorageReference fileReference = storageReference.child(timeStamp + "." + getMimeType(context, imageUri));
    ...
    public MutableLiveData<DatabaseReference> getTokenRef() {
        ...
        DatabaseReference reference = com.google.firebase.database.FirebaseDatabase.getInstance().getReference("Tokens");
    ...
    public MutableLiveData<Boolean> addImageUrlInDatabase(String imageUrl, Object mUri) {
        ...
        DatabaseReference reference = com.google.firebase.database.FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid());
    ...
    public MutableLiveData<Boolean> addStatusInDatabase(String statusUpdated, Object status) {
        ...
        DatabaseReference ref = com.google.firebase.database.FirebaseDatabase.getInstance().getReference("Users");
        HashMap<String, Object> map = new HashMap<>();
